...
## Purpose
TBD - defines the `users` table as the single source of truth for login
credentials, email, role, and verification status, independent of any other
domain table in the service.
