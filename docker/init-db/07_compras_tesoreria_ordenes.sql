-- Mirrors migrations/0003_compras_tesoreria_ordenes.sql for local Postgres
-- (docker-compose). Duplicated (rather than volume-mounted) for the same
-- reason 02_ctacteprov_detalle_and_iva.sql is — see that file's header.
